...
@Component
public class HqlAccessValidator {
  ...
  private String validateFieldWhitelist(String hqlQuery) {
    ...
    while (fieldMatcher.find()) {
      ...
      if (entity != null && !allowedFields.contains(field)) {
        return "ERROR: Field '" + field + "' from entity '" + entity
          + "' is not accessible via this assistant.";
      }
    }
  ...
  private String validateReadOnlyQuery(String hqlQuery) {
