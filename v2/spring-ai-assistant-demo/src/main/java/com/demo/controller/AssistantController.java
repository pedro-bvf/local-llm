...
public class AssistantController {
  ...
  public AssistantController(
      ...
      HibernateAssistantSpringAI assistant,
      @Value("${spring.ai.ollama.base-url:http://localhost:11434}") String ollamaBaseUrl,
      @Value("${spring.ai.ollama.chat.model:qwen2.5-coder:7b}") String ollamaModel) {
   ...
   */
  private String guarded(java.util.concurrent.Callable<String> action) {
    try {
      return action.call();
    } catch (Exception e) {
